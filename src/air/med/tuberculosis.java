...
public class tuberculosis {
    public static double ptuberculosis = 1;
    
    public static void main(String args[]) throws SQLException
    {
        String a = "tuberculosis";
        int len = args.length;
 ...
 ResultSetMetaData metadata = rs.getMetaData();
     ...
     catch(Exception e)
    {
      ...
      if(flag==1)
             {
                 Statement stmt1 = conn.createStatement();
                 if(ptuberculosis>0.3)
                 ar[6] = 1;
              String insert = "INSERT INTO airmed.tuberculosis VALUES('"+ar[0]+"','"+ar[1]+"','"+ar[2]+"','"+ar[3]+"','"+ar[4]+"','"+ar[5]+"','"+ar[6]+"');";
