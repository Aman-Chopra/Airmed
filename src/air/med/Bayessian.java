 ...
 * @author win-8
 */
public class Bayessian {
    public static double prob = 1;
    public static String dis = "AIDS";
      ...
      if(flag==1)
             {
                 ...
                 if(prob>0.3)
                 ar[6] = 1;
              String insert = "INSERT INTO airmed.aids VALUES('"+ar[0]+"','"+ar[1]+"','"+ar[2]+"','"+ar[3]+"','"+ar[4]+"','"+ar[5]+"','"+ar[6]+"');";
